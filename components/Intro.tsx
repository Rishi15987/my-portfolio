  ...
  return (
    <section className="h-screen relative w-full bg-zinc-900 overflow-clip">
        ...
        <div className="text-white h-full flex flex-col justify-center items-center gap-6">
            <div>
                <h1 className="text-4xl md:text-6xl py-4 text-center md:tracking-widest">Rishi Raj</h1>
                <p className="text-2xl md:text-3xl uppercase">Backend Software Engineer</p>
            </div>
