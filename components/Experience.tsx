...
const Experience = () => {
  return (
    <div className="h-auto pt-2 flex flex-col items-center bg-zinc-900 text-white">
      <div className="pl-8 pr-8 md:px-32 flex flex-col items-center gap-10 w-full text-center">
        ...
        <div className="relative grid lg:grid-cols-2 gap-20 lg:gap-30 pl-14 md:p-14 mt-20">
          ...
          <motion.div 
            ...
            className="hidden lg:block p-4 pt-6 text-left">Nov 2024 – Present</motion.div>
          <motion.div 
            initial={{ opacity: 0, x: -20}}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.3 , delay: 0.2 }}
            className="hidden lg:block p-4 pt-6 text-right">Jan 2023 – Oct 2024</motion.div>
          <motion.div 
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, x: 0 }}
          ...
          <motion.div 
            ...
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.3 , delay: 0.2 }}
            className="hidden lg:block p-4 pt-6 text-left">July 2021 – Aug 2021</motion.div>  
        </div>
      </div>
    </div>
  )
