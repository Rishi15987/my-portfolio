    ...
    <div className="h-[200vh] flex flex-col items-center bg-zinc-900 text-white">
      <div className="px-32 flex flex-col items-center gap-10 w-full text-center">
        ...
        <div className="relative grid grid-cols-2 gap-30 p-4 mt-20">
          <div className="absolute w-0.5 h-full bg-[#28D08A] top-0 left-1/2 "></div>
          <div className="group relative flex flex-col gap-1 rounded-sm p-4 bg-zinc-800 text-white text-left transition-all duration-300 hover:shadow-lg hover:shadow-zinc-800/20 border border-zinc-900">
              <motion.div 
                initial={{ rotate: 90 }}
                className="absolute z-10 border-l-[20px] -right-[30px] top-7 border-r-[20px] border-b-[20px] border-b-zinc-800 border border-zinc-900"></motion.div>
              <div className="absolute -right-[85px] rounded-full bg-zinc-800 text-white p-3 group-hover:bg-[#28D08A] transition-colors duration-300">
          ...
          <div className="p-4 pt-6 text-left">Nov 2024 – Present</div>
          <div className="p-4 pt-6 text-right">Jan 2023 – Oct 2024</div>
          <div className="group relative rounded-sm p-4 bg-zinc-800 text-white text-left">
              <motion.div 
                initial={{ rotate: 270 }}
                className="absolute border-l-[20px] -left-[30px] top-7 border-r-[20px] border-b-[20px] border-b-zinc-800 border border-zinc-900"></motion.div>
              <div className="absolute -left-[82px] rounded-full bg-zinc-800 text-white p-3 group-hover:bg-[#28D08A] transition-colors duration-300">
                <MdWork size={20} className="group-hover:text-white transition-colors duration-300"/>
              </div>
              <h1 className="text-xl font-semibold uppercase">System Engineer</h1>
              <p className="text-lg font-semibold text-[#28D08A]">Infosys - Bangalore, India</p>
          ...
          <div className="group relative rounded-sm p-4 bg-zinc-800 text-white text-left">
            <motion.div 
                  initial={{ rotate: 90 }}
                  className="absolute border-l-[20px] -right-[30px] top-7 border-r-[20px] border-b-[20px] border-b-zinc-800 border border-zinc-900">  
            </motion.div>
              <div className="absolute -right-[85px] rounded-full bg-zinc-800 text-white p-3 group-hover:bg-[#28D08A] transition-colors duration-300">
                <MdWork size={20} className="group-hover:text-white transition-colors duration-300"/>
              </div>
